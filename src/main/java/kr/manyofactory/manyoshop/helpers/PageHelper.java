...
public class PageHelper {
    ...
    private int offset; // MYSQL,MariaDB의 Limit시작 위치
    ...
    public PageHelper(int nowPage, int totalCount, int listCount, int groupCount) {
        ...
        // 이전 그룹의 마지막 페이지
        prevPage = (this.nowPage > 1) ? this.nowPage - 1 : this.nowPage;
        // 다음 그룹의 첫 페이지
        nextPage = (this.nowPage < totalPage) ? this.nowPage + 1 : this.nowPage;
        // 검색 범위의 시작 위치
