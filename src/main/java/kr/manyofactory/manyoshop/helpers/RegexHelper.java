...
public class RegexHelper {
     ...
     *
     * @param str - 검사할 문자열
     * @param message - 검사를 충족하지 않은 경우 표시할 예외 메시지
     ...
     *
     * @param str - 검사할 문자열
     * @param message - 조건을 충족하지 않은 경우 표시할 예외 메시지
     * @throws StringFormatException
     */
    ...
    public void isUrl(String str, String message) throws StringFormatException {
        if (!Pattern.matches("^(https?)://[-a-zA-Z0-9+&@#/%?=~_|!:,.;]*[-a-zA-Z0-9+&@#/%=~_|]$",
                str)) {
            throw new StringFormatException(message);
        }
    }
    ...
    /**
     * "-없이 점선번호형식인지에 대한 형식 검사.
     *
     * @param str - 검사할 문자열
     * @param message - 조건을 충족하지 않은 경우 표시할 예외 메시지
     * @throws StringFormatException
     */
    public void isCell(String str, String message) throws StringFormatException {
    ...
    /**
     * "-없이 점선번호 형식으로 핸드폰 번호 중 하나를 충족하는지 검사
     *
     * @param str - 검사할 문자열
     * @param message - 조건을 충족하지 않은 경우 표시할 예외 메시지
     * @throws StringFormatException
